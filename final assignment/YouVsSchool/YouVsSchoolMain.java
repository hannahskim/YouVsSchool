...
public class YouVsSchoolMain extends JFrame implements ActionListener
{
	...
	setIconImage (Toolkit.getDefaultToolkit ().getImage ("Images/Homework Icon.png"));

	// Sets up the YouVsSchool board that plays most of the game
    ...
    /** Responds to a Menu Event.  This method is needed since our
      * YouVsSchool frame implements ActionListener
	...
	{
	    YouVsSchoolBoard.enemyTimer.stop ();
	}
