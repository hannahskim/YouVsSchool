...
public class YouVsSchoolBoard extends JPanel implements MouseListener, KeyListener
{
    ...
    private final int ENEMY_TIME_INTERVAL = 500;
    private final int TIME_TRACKER_INTERVAL = 500;
    ...
    */
	...
	else
	{
	    ...
	    g.fillRect (100, 553, TIME_TRACKER_SPEED * LEVEL_LENGTH / ENEMY_TIME_INTERVAL, 15);
	    if (drawTimeTracker)
		g.drawImage (timeTracker, TIME_TRACKER_SPEED * timePassed / TIME_TRACKER_INTERVAL + 77, 538, this);
